...
/*
Метод get с лету накатал. А вот put заставил подумать.
Пока не заглянул в main и классы SomeValue и SomeKey, в голове всё в узел завязывалось от слов:
...
т.е. он принимает  объекты SomeValue (V), у которых берет значение поля с типом SomeKey (K) и делает его ключем в мапе, по которому кладет сам объект в качестве значения.
Т.е. нам для кеша не нужно придумывать ключи, ими  будет поле нашего класса.
 */
