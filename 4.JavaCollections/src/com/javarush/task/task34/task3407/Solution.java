...
public class Solution {
    ...
    public static class Helper {
        ...
        public List<PhantomReference<Monkey>> getPopulatedList() {
            ...
            //Тут создаем возвращаемый список
            for ( int i = 0; i < 200; i++)
            { // тут цикл для 200 объектов
                list.add(new PhantomReference<Monkey>(new Monkey(), helper.getQueue()));
            } //а тут в список добавляем объект в конструкторе которого создаем объект и передаем список призраков
            return list;
        }
