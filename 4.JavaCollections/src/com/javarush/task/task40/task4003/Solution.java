...
Требования:
1. Метод setAttachment должен устанавливать новый контент у сообщения message.
Тип контента должен быть MimeMultipart.
...
public class Solution {
   ...
   //     message.setText(filename);
        ...
        BodyPart messageBodyPart = new MimeBodyPart(); //MimeBodyPart - Часть тела мима
