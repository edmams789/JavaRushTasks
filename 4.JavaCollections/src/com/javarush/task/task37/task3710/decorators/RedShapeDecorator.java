...
/*
Decorator
Создай класс RedShapeDecorator в пакете decorators. Он должен расширять функциональность объектов типа
Shape не меняя их структуру.
...
4. В методе draw() класса RedShapeDecorator должен быть изменен цвет декорируемого объекта и вызван его
метод draw().
...
public class RedShapeDecorator extends ShapeDecorator {
    ...
    private void setBorderColor(Shape decoratedShape) {
        ...
        System.out.format("Setting the border color for %s to red.", decoratedShape.getClass().getSimpleName());
    }
}
