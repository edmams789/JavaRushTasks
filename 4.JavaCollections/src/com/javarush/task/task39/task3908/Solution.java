...
/*
Палиндром (от греч. palindromos – бегущий обратно) – слово, которое читается одинаково слева направо
и справа налево (например, ротор), поэтому такие слова еще называют перевертышами.
Самое длинное употребительное слово-палиндром в мире – saippuakauppias,
которое в переводе с финского означает «продавец мыла».

учитавая данное описание, почему не проходит следующее решение?
public static boolean isPalindromePermutation(String s) {
