...
- Только если наша цель - написать как можно меньше строк. А если цель написать легко читаемый код,
то лучше так не писать.
"Если ваш код способен понять не программист - это хороший код, а если нужно задумываться... Ну вы поняли"
 */