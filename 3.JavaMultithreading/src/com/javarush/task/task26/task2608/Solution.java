...
5. Synchronized блоки методов getSumOfVar1AndVar2() и getSumOfVar3AndVar4() должны использовать
мьютексы разных объектов.
*/
...
//Прежде чем решать или списывать прочтите это - ~1.5 мин чтения -
// ссылка https://docs.oracle.com/javase/tutorial/essential/concurrency/locksync.html
