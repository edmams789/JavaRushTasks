...
5. В методе get() класса Solution в synchronized блоке используй lock из массива locks в
зависимости от хэша объекта и количества лок объектов.
6. В методе clear() класса Solution в synchronized блоке используй lock из массива locks в
зависимости от индекса элемента и количества лок объектов.
*/
...
//Для решения и понимания этой задачи необходимо минимум посмотреть это видео.
//https://www.youtube.com/watch?v=0Aiw97_Y300&list=PLB0276A0A62BDEF06&index=12
//Если не целиком, то хотя бы с 50-й минуты.

//За пониманием решения сюда:
//http://info.javarush.ru/JavaRush_tasks_discussion/2014/03/13/level26-lesson08-task03.html