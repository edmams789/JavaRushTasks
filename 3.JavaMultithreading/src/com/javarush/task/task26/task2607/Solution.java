...
4. Класс IntegerHolder должен содержать public метод set(int value), который должен установить value
...
//Еще материал:
//https://stackoverflow.com/questions/9851133/when-to-use-volatile-and-synchronized