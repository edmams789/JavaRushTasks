...
4. Метод getPartOfString должен возвращать подстроку начиная с символа после 1-го пробела и до конца
...
public class Solution {
    ...
    public static String getPartOfString(String string) {
        ...
        return string.substring(string.indexOf(" ") + 1, string.indexOf(str[4]) + str[4].length());

        //return string.substring(string.indexOf(" ") + 1, string.indexOf(" ", string.indexOf(string.split(" ")[4])));
    }
