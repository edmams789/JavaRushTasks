...
5. Если ход, переданный в метод getMoveEfficiency не меняет игровое поле, должен быть возвращен объект
...
//равной и вернем ноль.
    @Override
    public int compareTo(MoveEfficiency o) {  // (Object o)
        if (numberOfEmptyTiles != o.numberOfEmptyTiles)
//15.2. Метод compareTo должен корректно сравнивать два объекта типа MoveEfficiency.
