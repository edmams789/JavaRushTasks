...
UncaughtExceptionHandler должен маскировать звездочками имя трэда и выводить в консоль описание
возникшей ошибки.
...
public class Solution extends TimerTask {
    ...
    public Solution(TimerTask original) {
      ...
      //  this.handler = null;    //init handler here - обработчик инициализации здесь
