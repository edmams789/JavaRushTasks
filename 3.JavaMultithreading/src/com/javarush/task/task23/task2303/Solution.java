...
//Абстрактный класса разрешает наследование, но запрещает создание объектов класса.
//А финальный класс наоборот запрещает наследование, но разрешает создание объектов класса.