...
//Крепко запоминаем конструкцию
//Внешнийкласс.this.методВнешнегоКласса();
//
//так мы обращаемся к методу внешнего класса ИЗ ВНУТРЕННЕГО(inner).
//
//на то она и практика, чтобы закрепить то, что Элли уже рассказала (3-я лекция).
//
//p.s. конечно, если метод с таким названием в единственном экземпляре, можно сразу указывать его имя.