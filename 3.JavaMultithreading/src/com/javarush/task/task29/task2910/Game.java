...
//            if (BigDecimal.valueOf(members.get(i).getResultTime().doubleValue()).equals
//                    (BigDecimal.valueOf(controlSportsman.getResultTime().doubleValue()))) {

//                if (BigDecimal.valueOf(members.get(i).getResultTime().doubleValue()).equals
//                        (controlSportsman.getResultTime())) {
...
//В методе initializeControlSportsman() класса Game обрати внимание на создание нового объекта BigDecimal.