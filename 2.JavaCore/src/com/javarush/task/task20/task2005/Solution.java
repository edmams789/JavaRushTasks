...
//Для ленивых - удаляем уже имеющиеся equals() и hashCode() и на их место через Alt+Ins генерим новые.
// Вуаля! Вы восхитительны!
//Для пытливых - читаем как правильно переопределяется equals().
// Надо грамотно сравнить два поля (добавятся две строки вместо уже имеющихся).
// А в hashCode() ошибка очевидна (в возвращаемом значении).