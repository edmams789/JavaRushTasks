...
8. Метод main должен выводить значения полей на экран(каждое с новой строки
или через пробел) в заданном порядке. Инициализировать переменные не нужно.
*/
...
//Solution(int intVar, double doubleVar, Double DoubleVar, boolean booleanVar, Object ObjectVar,
//             Exception ExceptionVar, String StringVar) {
//        this.intVar = intVar;
...
//К не статическим переменным нельзя обратиться из статического метода без объекта.
// Вот собственно и решение. Задача огонь
