...
Упрости код - убери все наследования и реализации, которые и так будут добавлены автоматически
при компиляции
...
public class Solution {
    ...
    public static class JuniorJavaDev extends JavaDev implements Serializable {
