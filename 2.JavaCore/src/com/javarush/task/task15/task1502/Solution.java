...
7. Область видимости переопределенных методов getSize в классах Goose и Dragon должна быть расширена
до максимальной.
*/
...
public class Solution {
    ...
    public static class Goose extends SmallAnimal {
        ...
        public String getSize() {
            return "Гусь маленький, " + Goose.super.getSize();
         //   System.out.println();
        }
    ...
    public static class Dragon extends BigAnimal {
        @Override
        public String getSize() {
            return "Дракон большой, " + Dragon.super.getSize();
        }
    }
