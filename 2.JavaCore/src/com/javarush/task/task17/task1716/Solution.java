...
//Вообще, по Эккелю - нужно следовать правилу Брайана: "Если вы записываете данные в переменную,
// которая может быть затем прочитана другим потоком, или читаете данные из переменной,
// которая могла быть записана другим потоком, вы должны использовать синхронизацию..."
// В условии задачи сказано, что объект класса Solution будет использоваться нитями.
// Solution, между тем, имеет всего 2 переменные класса (которые, потенциально,
// могут быть общими для разных нитей). Отсюда - все просто - те методы,
