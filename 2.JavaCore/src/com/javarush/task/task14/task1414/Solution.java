...
6. Для каждой введенной строки (в том числе для некорректной) необходимо
...
public class Solution {
    public static void main(String[] args) throws Exception {
        ...
        String key = null;
//    while (true) {
//    if ((key = reader.readLine()).equals("cartoon")||key.equals("thriller")||
...
//        break;
//    }
//} || (key = reader.readLine()) != null



     //   while ((key = reader.readLine()) != null)

        while((key = reader.readLine()).equals("cartoon")||key.equals("thriller")||
                key.equals("soapOpera"))
        {
            MovieFactory.getMovie(key);
...
8.2 вывести на экран movie.getClass().getSimpleName()
    ...
    static class Cartoon extends Movie { //Мультфильм
