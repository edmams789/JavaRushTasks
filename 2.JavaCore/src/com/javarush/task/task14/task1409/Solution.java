...
5. В классе Solution должен быть реализован публичный(public) метод println c одним параметром
типа Bridge.
...
//пишу классы в 1 файле, потом курсор ставлю на названия классов,
// которые хочу вынести в отдельные файлы и жму F6.