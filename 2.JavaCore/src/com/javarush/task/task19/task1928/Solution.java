...
//Исправление возможно в двух вариантах:
//1. исправить условия в if
//if (result instanceof C) {
//C p = (C) result;
//System.out.println(p.getClass().getSimpleName());
//}
//
//2. исправить приведение типов
//if (result instanceof A) {
//A p = (A) result;
//System.out.println(p.getClass().getSimpleName());
//}
//
//Но валидатор принимает почему-то только 1-й вариант.
//Хотя, учитывая код и то, что всегда создается объект и типа A,
// логичнее было бы исправлять по варианту 2,
// т.к. по варианту 1 проверка в if всегда будет false и в тело if'а мы никогда не войдем...