...
//Это полиморфизм. В этом его прелесть. Мы можем в метод print передать любой объект
// реализующий интерфейс Drink, и (вот самый смак) в зависимости от передаваемого объекта
// будет вызван соответствующий переопределённый метод.